...
define(__id, 69)dnl
include(header.html)
<p>Time for a little honesty here. I actually had a fairly lousy month
  in December&mdash;for the first time in almost two years I went through a
  month where I didn't feel at the end like I was at all better at
  what I do than I was at the month's beginning. Sure,  I had
  learned <a
  href='http://technomancy.us/68'>a</a> <a
  href='http://technomancy.us/66'>lot</a>
  about <a
...
<p>I'm sure most of this was due to the fact that I spent most of
  the month looking for work or waiting for projects to get
  started. I tried to keep busy with personal projects and whatnot,
  but when I finally did start on a Rails job at the beginning of
  this month, it was a bit distressing how rusty I felt. Part of
  this was also due to picking up both RSpec and the new Restful
  style, which was a bit disorienting. (Though Geoffrey's excellent
  PeepCode screencast helped a lot with that; give it a spin if
  you're having trouble.)</p>
...
<p>On an entirely unrelated note,  when I was first getting into Ruby (around RubyConf '05), 
  I <a href="http://technomancy.us/8">joked about how "Ruby
