...
<div id='wrapper'>
  <p>Over the years
    I've <a href="/137">written</a>
    and <a href="https://usesthis.com/interviews/phil.hagelberg/">been
      interviewed</a> about the hardware and software I use. But more
    recently I've kept a log of changes here for things that are too
    dull to warrant a full post.</p>
  ...
  <dl style="font-size: 125%">
    ...
    <dt>2012</dt>
    <dd>Got <a href="https://usesthis.com/interviews/phil.hagelberg/">interviewed
        on The Setup</a> about what hardware and software I use.
        Started using <a href="/160">a Samsung S9</a> for a while in
  ...
  <p>At this point I'm afraid I'm never going to find a modern laptop
  ...
  <p>I'm even willing to give up the replaceable battery, and I'll put
    up with a garbage keyboard because I always use an external one
    anyway, and I don't care <em>anything</em> for performance, but
