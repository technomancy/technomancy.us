...
define(__id, 112)dnl
include(header.html)
<p>I've been <a href='http://diveintomark.org/archives/2008/06/21/minimalism'>inspired</a> 
to take a more minimalist approach with the design of this site.</p>

<p>Most obvious is the reduction of <a
href='http://tomayko.com/writings/administrative-debris'>administrative
...
href='http://twitter.com/gilesgoatboy/statuses/825666128'>going
...
href='https://addons.mozilla.org/en-US/firefox/addon/2933'>an
extension</a> to make use of them, but <a
href='http://conkeror.org'>Conkeror</a>'s got support built in bound
...
href='https://bugzilla.mozilla.org/show_bug.cgi?id=291340'>petition
