...
<p>Well, it's finally out! I'm proud to announce that the Peepcode
  ...
  released and is
  <a href='https://www.pluralsight.com/courses/meet-emacs'>available for
  download</a>: an hour's worth of high-bandwidth
  knowledge transfer as only Mr. Grosenbach can deliver.</p>

<p><a href='https://www.pluralsight.com/courses/meet-emacs'><img src='/i/emacs-peepcode.png'
                                                        alt='meet emacs' class='right' /></a></p>

<p><b>Update</b>: PeepCode video courses are now distributed by PluralSight.</p>
...
<p>So
  far <a href='http://search.twitter.com/search?q=emacs+peepcode'>the
